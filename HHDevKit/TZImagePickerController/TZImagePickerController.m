...
- (void)viewDidLoad {
    ...
    if (iOS7Later) {
        self.navigationBar.barTintColor = HH_COLOR_NAVIGATION_BAR;//[UIColor colorWithRed:(34/255.0) green:(34/255.0)  blue:(34/255.0) alpha:1.0];
...
- (void)viewDidLayoutSubviews {
    ...
    if (@available(iOS 11, *)) {
        ...
        frame.size.height = self.view.tz_height - frame.origin.y;
